...
echo '<input class="controle" type="text" placeholder="pseudo adherent" name="pseudo" id="pseudo" pattern="[a-zA-Z-\.]{3,20}" required > <span id="err"></span>';
echo '</div>';
echo '<div class="input_field">';
echo '<input class="controle" type="password"  placeholder="mot depasse"  name="mdp" id="mdp" pattern="[0-9a-zA-Z-\.]{3,20}" required ><span class="resultat"></span>';
echo '</div> <br>';
